      ...
      seqfile = Amblycera_all_genes_alignment.fasta * sequence data file name
      outfile = Amblycera_mlb        * main result file
     treefile = Amblycera_concatenated.tree  * tree structure file name
